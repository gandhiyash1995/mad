...
if($num==0)
{
header('location:http://localhost/MAD/EnggForm.php');
}	
mysqli_close($con);
?>
<!DOCTYPE HTML>
...
<body bgcolor="#e9e9e9">
<p><a href="EnggForm.php"><img style="height:10% ; width:5%; display:none;" src="http://localhost/MAD/images/left.png"></a></p>
<p id="p1" style="font-size:20px;display:none;"><i>A good scientist is person with original ideas. A good engineer is a person who makes a design that <br>works with as few original ideas as possible. There are no prima donnas in engineering</i></p>.
<button style="margin-left:38%;">Click here to view your course details</button>
<div id="dance" style="display:none;"><img  src="http://localhost/MAD/images/tech.jpg" style="width:40%;height:50%;margin-left:30%;margin-top:10%;border:2px solid blue;"/></div>
